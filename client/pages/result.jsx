        ...
        <div className="container">
           <div className="d-flex row">
             ...
             <div className="col-12 h-100 col-md-6">
                ...
                <h1 className="m-4 d-flex justify-content-end plan">
                  {plan.planName}
                <i onClick={this.handleTrash} className="pointer trash fas fa-trash"></i>
                </h1>
                <a href={`#activityForm?planId=${plan.planId}`} className="d-flex justify-content-end flex-row">
